...
public class LoginTest {
	...
	@BeforeAll
	public static void beforeAll() { //Método para setar a variável em uma única vez antes de todos 
	...
	@BeforeEach	
	public void beforeEach() { // Método para abrir em todos os testes o Chrome
	...
	@AfterEach	
	public void afterEach() { //Método para em todos os testes fechar a aba
        this.browser.quit();
	}
